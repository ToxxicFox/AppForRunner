...
public class JDBCDataProviderTest {
    ...
    public void addRunner() throws Exception {
        List<Runner> runnerList = ModelsSeeder.seedRunner(5);
    ...
    public void addTraining() throws Exception{
        List<Training> trainingList = ModelsSeeder.seedTraining(5);
    ...
    public void addMarathonTrn() throws Exception {
        List<MarathonTraining> marathonTrainingList = ModelsSeeder.seedMarathonTrn(5);
    ...
    public void addSprinterTrn() throws Exception {
        List<SprinterTraining> sprinterTrainingList = ModelsSeeder.seedSprinterTrn(5);
    ...
    public void addChallenge() throws Exception {
        List<Challenge> challengeList = ModelsSeeder.seedChallenge(5);
